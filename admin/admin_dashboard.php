  ...
  <main class="main-content">
      ...
      <section id="subadmin" class="section">
        <div class="section-header">
          <h2 style="color:#ffd700;margin:0">Sub Admins</h2>
          <a href="./crud/create.php" class="create-btn"><i class="bi bi-person-plus-fill"></i> Create Sub‑Admin</a>
        </div>

        <div class="table-wrap">
          <table class="subadmin-table" role="table" aria-label="Sub admins list">
            <thead>
              <tr>
                <th>S.No</th>
            ...
            <tbody>
              ...
              $query = "SELECT * FROM sub_admins WHERE status = 'active'";
              $result = mysqli_query($connect, $query);
              ...
              if ($result && mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  ?>
                  <tr>
                    <td><?= htmlspecialchars($rowId) ?></td>
                    <td><?= htmlspecialchars($subadmin_id) ?></td>
                    <td><?= htmlspecialchars($name) ?></td>
                    <td><?= htmlspecialchars($manager_id) ?></td>
                    <td><?= htmlspecialchars($email) ?></td>
                    <td class="actions">
                      <a class="btn edit" href="./crud/view.php?subadmin_id=<?= $subadmin_id ?>">View</a>
                      <a class="btn edit" href="./crud/edit.php?subadmin_id=<?= $subadmin_id ?>">Edit</a>
                      <form action="./crud/process.php" method="POST" style="display:inline-block;">
                        <input type="hidden" name="subadmin_id" value="<?= $subadmin_id ?>">
                        <button type="submit" name="subadmin_delete" class="btn delete">Delete</button>
                      </form>
                    </td>
                  </tr>
                  <?php
